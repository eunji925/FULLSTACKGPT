...
# 2.Allow the user to customize the difficulty of the test and make the LLM generate hard or easy questions. 
# 3.Allow the user to retake the test if not all answers are correct. 
# 4.If all answers are correct use st.ballons. 
